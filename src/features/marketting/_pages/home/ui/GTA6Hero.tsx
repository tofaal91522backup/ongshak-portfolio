...
export default function GTA6Hero() {
      ...
      <div className="hero-1-container w-full h-screen relative">
        ...
        <div
          ...
          style={{
            ...
            backgroundImage: "url('/ongshak-logo.png')",
        ...
        >
          ...
          {/* Hero Logo */}
          <img
            className="hero-main-logo w-full h-screen absolute inset-0 z-[1] object-cover "
            draggable={false}
            src="/ongshak_same_look_transparent_2048x1051.png"
            alt="GTA VI logo"
          />
        </div>
      ...
      >
        <div className="w-full lg:max-w-[60%] lg:mx-auto flex flex-col md:gap-8 gap-6">
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm font-medium">
            <span>347+ Projects Delivered</span>
            <span>|</span>
